...
SELECT rt.id, cap, 'company'::capability_scope
  ...
  ('developer', ARRAY[
    ...
    'crm.assign', 'crm.create', 'crm.dealValues', 'crm.delegate',
    ...
    'leads.create', 'marketing.approve', 'marketing.edit', 'news.view',
    ...
    'stock.edit', 'stock.export', 'stock.view', 'tracker.view',
    'work.analytics', 'work.analyticsAll', 'work.approve', 'work.assignDepartment',
    'work.assignOthers', 'work.create', 'work.decideRelease', 'work.delete',
    'work.edit', 'work.editAny', 'work.forceRelease', 'work.manageFields',
    'work.manageProjects', 'work.manageSystemViews', 'work.projects', 'work.publishProject',
    'work.reassign', 'work.requestRelease', 'work.review', 'work.rollback',
    'work.schedule', 'work.setDue', 'work.shareViews', 'work.view',
    'work.viewAll', 'work.viewDepartment', 'work.views'
  ]),
  ...
  ('business_development', ARRAY[
    ...
    'crm.create', 'crm.dealValues', 'crm.delegate', 'crm.delete',
    ...
    'stock.view', 'tracker.view', 'work.analytics', 'work.approve',
    'work.assignDepartment', 'work.assignOthers', 'work.create', 'work.decideRelease',
    'work.edit', 'work.editAny', 'work.manageProjects', 'work.projects',
    'work.reassign', 'work.requestRelease', 'work.review', 'work.setDue',
  ...
  ('sr_sales', ARRAY[
    ...
    'crm.health', 'crm.import', 'crm.manageLists', 'crm.proposal',
    'crm.proposalForOthers', 'crm.view', 'crm.viewGlobal', 'crm.viewOthers',
    'entity.setOwn', 'finder.view', 'fleetsmart.build', 'fleetsmart.discount',
    'fleetsmart.send', 'fleetsmart.view', 'leads.create', 'news.view',
    'reports.export', 'reports.view', 'revenue.export', 'revenue.import',
    'revenue.view', 'social.view', 'stock.edit', 'stock.export',
    'stock.view', 'tracker.view', 'work.analytics', 'work.approve',
    'work.assignDepartment', 'work.assignOthers', 'work.create', 'work.decideRelease',
    'work.edit', 'work.editAny', 'work.reassign', 'work.requestRelease',
    'work.review', 'work.setDue', 'work.view', 'work.viewAll',
    'work.viewDepartment', 'work.views'
  ]),
  -- Sales (34)
  ('sales_rep', ARRAY[
    'access.request', 'analytics.view', 'brand.view', 'crm.assign',
    'crm.create', 'crm.dealValues', 'crm.delegate', 'crm.edit',
    'crm.enrich', 'crm.health', 'crm.manageLists', 'crm.proposal',
    'crm.view', 'crm.viewGlobal', 'entity.setOwn', 'finder.view',
    'fleetsmart.build', 'fleetsmart.send', 'fleetsmart.view', 'leads.create',
    'news.view', 'reports.export', 'reports.view', 'revenue.view',
    'social.view', 'stock.edit', 'stock.view', 'tracker.view',
    'work.create', 'work.edit', 'work.requestRelease', 'work.setDue',
    'work.view', 'work.views'
  ]),
  -- Sr Marketing (51)
  ('sr_marketing', ARRAY[
  ...
  ('sr_finance', ARRAY[
    ...
    'crm.dealValues', 'crm.delegate', 'crm.delete', 'crm.edit',
    ...
    'entity.viewAll', 'finder.view', 'fleetsmart.build', 'fleetsmart.discount',
    'fleetsmart.send', 'fleetsmart.view', 'leads.create', 'reports.export',
