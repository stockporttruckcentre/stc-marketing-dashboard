...
INSERT INTO command_capability_roles (capability, role) VALUES
  ...
  ('analytics.targets', 'admin'),
  ('analytics.view', 'admin'),
  ('analytics.view', 'marketer'),
  ('analytics.view', 'sales'),
  ('analytics.view', 'viewer'),
  ('brand.manage', 'admin'),
  ('brand.manage', 'marketer'),
  ('brand.view', 'admin'),
  ('brand.view', 'marketer'),
  ...
  ('reports.view', 'admin'),
  ('reports.view', 'marketer'),
  ('reports.view', 'sales'),
  ('reports.view', 'viewer'),
  ('revenue.export', 'admin'),
  ('revenue.export', 'marketer'),
  ('revenue.export', 'sales'),
  ('revenue.export', 'viewer'),
  ('revenue.import', 'admin'),
  ('revenue.import', 'sales'),
  ('revenue.view', 'admin'),
  ('revenue.view', 'marketer'),
  ('revenue.view', 'sales'),
  ('revenue.view', 'viewer'),
