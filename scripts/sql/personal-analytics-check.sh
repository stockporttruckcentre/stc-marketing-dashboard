#!/usr/bin/env bash
# The Personal Analytics authority ladder, driven against real PostgreSQL.
set -u
...
out=$(psql -p 55432 -U postgres -d stctest -q -f scripts/sql/personal-analytics-check.sql 2>&1)
