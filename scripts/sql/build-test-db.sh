...
for m in 009_list_visibility_recursion 007_command_apply 008_writable_columns_seed 010_command_invoke 011_command_apply_lifecycle 012_command_create_list 013_command_share_list 014_command_attachments; do
