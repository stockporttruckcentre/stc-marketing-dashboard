...
import { MonthlyStack, type MonthPoint, type Shape } from '@/components/analytics/legacy/monthly';
import { Donut } from '@/components/analytics/legacy/donut';
import { DivergingBars, RankedBars, type BarRow } from '@/components/analytics/legacy/bars';
import {
  Key, Panel, PanelGrid, Segments, Toggle, type TableRow,
} from '@/components/analytics/legacy/panel';
